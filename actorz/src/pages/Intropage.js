      ...
      <div className="blockPosition2">
        ...
        <div className="middleContents2"> 
            ...
            <div className="actorCardposition">
              <div className="actorpPhotoposition">
              ...
              <div className="actorpPhotoposition">
                <img src="https://media.vlpt.us/images/iooi75/post/29ea4238-2775-433a-9e03-1d615fe50434/image.png" alt=""
                  className="actor2001"
                />
              </div>
