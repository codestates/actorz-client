...
const SendEmail = ({ closePost, setEmailClick, userInfo, postData }) => {
  ...
  const send = () => {
    ...
    const { name, bName, phoneNum, jobTitle, message } = emailContent;
        ...
        .then((res) => {
          if (res.status === 200) {
            ...
            Modal.error({
              title: "명함 전송 실패",
              content:
                "이메일을 보내던 중 오류가 발생하였습니다. 다시 시도해보시기 바랍니다.",
            });
            setEmailClick(false);
          }
          setLoading(false);
              ...
              >
                ...
                >
                  <div id="email-container">
                    ...
                    <div className="email-welcome-message">
                      배우 [&nbsp;<b>{postData.userInfo.name}</b>&nbsp;] 에게
                      명함을 보냅니다
                    </div>
                    <div className="email-modal-row-content">
                      <div
                        className="email-modal-row-label"
                    ...
                    <div className="email-modal-row-content">
                      <div className="email-modal-row-label">소속기관</div>
                      <div className="email-modal-row-value">
                        <input
                    ...
                    <div className="email-modal-row-content">
                      <div className="email-modal-row-label">전화번호</div>
                      <div className="email-modal-row-value">
                        <input
                          type="text"
                          name="phoneNum"
                    ...
                    <div className="email-modal-row-content">
                      ...
                      <div className="email-modal-row-value">
                        <div className="email-form-radio">
                          <Radio.Group
                            onChange={handleRecruiterEmailValue}
                            value={recruiterEmail}
                          >
                            <Space direction="vertical">
                              <Radio value={userInfo.email}>
                                {userInfo.email}
                              </Radio>
                              {userInfo.recruiter.bEmail ? (
                                <>
                                  <Radio value={userInfo.recruiter.bEmail}>
                                    {userInfo.recruiter.bEmail}
                                  </Radio>
                                </>
                              ) : (
                    ...
                    <div className="email-send-btn-position">
                      {err ? (
                        <div className="email-err-message">{err}</div>
                      ) : null}
                      <button
                ...
                >
                  <div id="email-container-mobile-vertical-center">
                    <div id="email-container-mobile">
                      ...
                      <div className="email-welcome-message-mobile">
                        배우 [&nbsp;<b>{postData.userInfo.name}</b>&nbsp;] 에게
                        명함을 보냅니다
                      </div>
